          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-base">{profile?.name || 'N/A'}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-base">{profile?.title || 'N/A'}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-muted-foreground">Role</p>
                <p className="text-base">{profile?.system_role || profile?.requested_role}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-muted-foreground">Status</p>
                <StatusBadge status={profile?.status || 'PENDING'} type="user" />
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Track your daily work activities</CardDescription>
              </div>
